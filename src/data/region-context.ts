...
export const regionContexts: RegionContext[] = [
  ...
  // ─── 비서울 지역 ───
  {
    id: '부산-해운대',
    name: '해운대/부산',
    dailyFootTraffic: 130000,
    peakHours: '10:00~22:00',
    targetDemo: '전 연령대. 관광객 + 해양 레저 중심. 해수욕장 인근 옥외광고 효과 우수',
    nearbyStations: ['해운대역', '벡스코역', '센텀시티역'],
    hotspots: ['해운대 해수욕장', '광안리', '벡스코', '센텀시티'],
    recommendation: '부산 최대 관광지로 해수욕장 인근 대형 LED 전광판과 해변 이벤트에 최적이에요. 여름 시즌 유동인구가 폭발적으로 증가해요.',
    statistics: {
      dailyVisitors: 130000,
      subwayDailyUsers: 52000,
      subwayRank: 1,
      externalVisitorRatio: 82,
      stationHighlight: '부산 1위 관광지, 해변 대형 LED 최적',
  ...
  },
  {
    id: '대구-동성로',
    name: '동성로/대구',
    dailyFootTraffic: 95000,
    peakHours: '11:00~22:00',
    targetDemo: '10~30대 중심. 대구 최대 번화가, 패션/문화 거리',
    nearbyStations: ['중앙로역', '반월당역', '동대구역'],
    hotspots: ['동성로거리', '대구 약령시', '서문시장', '김광석거리'],
    recommendation: '대구 최대 번화가로 젊은 유동인구가 집중되는 지역이에요. 중앙로역 환승통로와 동성로 보행자거리 옥외광고가 효과적이에요.',
    statistics: {
      dailyVisitors: 95000,
      subwayDailyUsers: 38000,
      subwayRank: 1,
      externalVisitorRatio: 58,
      stationHighlight: '대구 1위 번화가, 보행자거리 광고 최적',
      englishName: 'Dongseongno',
